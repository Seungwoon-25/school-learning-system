...
def teacher_attendance():
    ...
    st.markdown(
        """
        <div class="apple-hero apple-hero-dark">

            <div class="hero-eyebrow">
                TEACHER
            </div>

            <div class="hero-title hero-title-dark">
                전체 출결 관리
            </div>

            <div class="hero-description hero-description-dark">
                학생들의 출결 상태를 확인하고<br>
                최종 출결을 확정할 수 있습니다.
            </div>
